...
st.caption("Create strong, secure, and customizable passwords with just a click.")
st.write(
    "This app generates a random password based on your preferences. Choose the length and whether to include numbers or special characters (like punctuation and symbols)."
)
